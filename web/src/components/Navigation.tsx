import { EarthIcon, LibraryIcon, PaperclipIcon, UserCircleIcon, DownloadIcon } from "lucide-react";
...
const Navigation = observer((props: Props) => {
  ...
  const exportImportNavLink: NavLinkItem = {
    id: "header-export-import",
    path: Routes.EXPORT_IMPORT,
    title: "Export/Import",
    icon: <DownloadIcon className="w-6 h-auto shrink-0" />,
  };
  ...
  const navLinks: NavLinkItem[] = currentUser
      ? [homeNavLink, exploreNavLink, attachmentsNavLink, exportImportNavLink]
